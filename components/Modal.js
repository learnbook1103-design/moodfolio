      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100000] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-2xl max-h-[80vh] bg-gray-800/80 border border-white/10 rounded-2xl shadow-2xl flex flex-col"
          >
            ...
            {footerContent ? (
              ...
              <div className="p-4 border-t border-white/10 text-right bg-gray-900/50 rounded-b-2xl">
                <button
                  onClick={onClose}
